...
class ReportController extends Controller
{
    ...
    public function get_profit_loss_statement(Request $request) {
       ...
       if($validator->fails())
        ...
        {     
            ...
            $from_date = $request->from_date;  // 2022-09-07
    ...
    public function ExportExcel($exportData,$fileName,$from_date,$to_date){
        ...
        try { 
            $logo_url = url('/assets/admin/images/mainlogo.png');
            
            $objDrawing = new \PHPExcel_Worksheet_HeaderFooterDrawing();
            $objDrawing->setName('PHPExcel logo');
            // /public/excel/
            // https://stage.tasksplan.com/itm/assets/admin/images/mainlogo.png
            $objDrawing->setPath('mainlogo.png');
            // $objDrawing->setPath('../../../public/assets/admin/images/mainlogo.png');
            // $objDrawing->setPath(asset('/admin/images/mainlogo.png'));
            ...
            { 
               ...
               // dd($val['data']);
                ...
                // ->getStartColor()->setARGB('00c0e8e8');
                /*$spreadSheet->getActiveSheet()->getStyle('A1:A30')->getFill()
                ->setFillType(\PHPExcel_Style_Fill::FILL_SOLID)
                ->getStartColor()->setARGB('00c0e8e8');*/
                
                // $spreadSheet->getActiveSheet()->getStyle('A10:AZ10')->getFont()->setBold(true);               
            } 
            ...
            $Excel_writer->save($file);  // store file on server

            $data["user_name"] = Auth::user()->name;
            $data["pancard_no"] = Auth::user()->pan_card_no;
            $data["period"] = $from_date." to ".$to_date;

            $data["email"] = Auth::user()->email; // "manvendrajploft@gmail.com";
