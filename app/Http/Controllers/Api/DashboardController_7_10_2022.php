...
class DashboardController extends Controller
{
    ...
    public function add_money(Request $request) {
       ...
       if($validator->fails())
        ...
        {    
            ...
            if($request->type=='2'){ // For Trading Wallet
                ...
                $st_row->remark = 'payment credit to user'; 
            ...
            }else if($request->type=='1'){ // For Launcher Wallet
                ...
                if($st_row->save()){
                    ...
                    if($request->transaction_type==2){  // for transfer money Trader to Launcher Wallet
                        ...
                        $trad_row->remark = 'payment debit to user';
                        if($request->transaction_type==2){
                            $st_row->is_transfer = '1';
                        }
                        $trad_row->save();
            ...
            return $this->success("Balance added to wallet",$data);     
        }    
    }
    ...
    public function withdraw_money(Request $request) {
       ...
       if($validator->fails())
        ...
        {    
            ...
            $st_row->user_id = $user_id;
            $st_row->user_wallet_type = $request->type; 
    ...
    public function launchpad_ico_images(Request $request){
        ...
        select(['launchpaid.id','launchpaid.launch_image','launchpaid.user_id','launchpaid.launch_sketch','launchpaid.launch_designation','launch_paid_data.img_quanity','launch_paid_data.img_offered','launch_paid_data.img_sell as price',
            DB::raw('concat(launch_paid_data.start_date," ","'.$start_time.'") as start_date'),
            DB::raw('concat(launch_paid_data.end_date," ","'.$end_time.'") as end_date'), 
    ...
    {   
        ...
        try{
            ...
            if($launch_paid_data->save())
            {
                ...
                return $this->success("Your ICO Launchpad successfully",$data);
            } 
