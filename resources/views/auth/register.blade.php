								...
								<div class="border p-4 rounded">
									...
									{{-- <div class="d-grid">
										<a class="btn my-4 shadow-sm btn-white" href="javascript:;"> <span class="d-flex justify-content-center align-items-center">
                                            <img class="me-2" src="assets/admin/images/search.svg" width="16" alt="Image Description">
									...
									<div class="form-body">
                                        <form method="POST" class="row g-3" action="{{ route('register') }}">
                                            ...
                                            <div class="col-12">
												...
												<input type="text" name="name" class="form-control" id="inputName" value="{{ old('name') }}" placeholder="Enter Name" autofocus>
											</div>
											<div class="col-12">
                                            ...
                                            <div class="col-12">
												...
												<div class="input-group" id="password_confirmation">
													<input type="password" name="password_confirmation" class="form-control border-end-0" id="password_confirmation" value="" placeholder="Enter Confirm Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
