...
<div class="card">
    <div class="card-body">
        ...
        <form data-filter-action="" method="post">
            ...
            <div class="col-2">
                <label>Launched Status </label>
                {!! Form::select('launch_status',[''=>'Select Status']+\Config::get('constants.launcherIcoStatus'),null,['class'=>'form-control form-control-sm launch_status','id'=>'launch_status']) !!}
            </div>
            <div class="col-12">
...
function unCheckAll(){
   ...
   var userTable =  $('#users-table').DataTable({
        ...
        pageLength: 50,
        ajax: {
            url:'{!! route("launch_image") !!}',
            data: function (d) {
                d.name = $('.name').val(),
                d.email = $('.email').val(),
                d.mobile = $('.mobile').val(),
                d.launch_status = $('.launch_status').val()
        ...
        columns:[
            ...
            {data:"launch_status",name:"launch_status"},
