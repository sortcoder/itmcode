...
<form action="" method="post" id="createUser">
    <div class="card">
        <div class="card-header"><h5>Add New Video </h5></div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-2">
                    ...
                    <input type="text" step="any" class="form-control" name="title" id="title" placeholder="Enter video title">
                </div>
                <div class="col-12 mt-2">
                    <label for="youtube_link">Youtube Video Link</label>
                    <input type="url"  class="form-control" name="youtube_link" id="youtube_link" placeholder="Youtube Video Link">
                </div>
                ...
                <div class="col-3 mt-2">
                    ...
                    $videoOption = [
                     ...
                     ?>
                    <?=_dropzoneCreateUpdate('image','',$videoOption)?>
                </div>
