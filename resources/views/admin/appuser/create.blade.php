        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-4 mt-2">
                    ...
                    <input type="text" class="form-control datepicker" name="dob" id="dob" placeholder="Enter your dob">
                </div>
                <div class="col-4 mt-2">
                    <label for="gender">Gender</label>
                    {!! Form::select('gender',[''=>'SelectGender']+Config::get('constants.genderStatus'),null,['class'=>'form-control','id'=>'gender']) !!}
                </div>
                <div class="col-4 mt-2">
                    <label for="marital_status">Martial Status</label>
                    {!! Form::select('marital_status',[''=>'Select Martial Status']+Config::get('constants.maritalStatus'),null,['class'=>'form-control','id'=>'marital_status']) !!}
                </div>
                <div class="col-4 mt-2">
                    <label for="profession">Professional</label>
                    {!! Form::select('profession',\App\Models\Professional::makeToArray(),null,['class'=>'form-control','id'=>'profession']) !!}
                </div>
                <div class="col-4 mt-2">
                    <label for="user_type">User Type</label>
                    {!! Form::select('user_type',[2=>'Trader',3=>'Launcer'],null,['class'=>'form-control','id'=>'user_type']) !!}
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-6">
                    ...
                    <textarea name="address_one" id="address_one" class="form-control" cols="30" rows="3"></textarea>
                </div>
                <div class="col-6">
                    <label for="address_two">Address line2</label>
                    <textarea name="address_two" id="address_two" class="form-control" cols="30" rows="3"></textarea>
                </div>
                <div class="col-6 mt-2">
                    <label for="state">State</label>
                    {!! Form::select('state',[''=>'Select State']+\App\Models\State::fetchStates(),null,['class'=>'form-control','id'=>'state']) !!}
                </div>
                <div class="col-6 mt-2">
                ...
                <div class="col-6 mt-2">
                    ...
                    <input type="text" class="form-control datepicker" maxlength="6" name="pincode" id="pincode" placeholder="Pincode">
                </div>
                <div class="col-6 mt-2">
                    <label for="city">City</label>
                    <input type="text" class="form-control datepicker" name="city" id="city" placeholder="City">
                </div>

            </div>
            <div class="row mt-3 kyc_status" style="display: none">
                <hr/>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" name="re_pan_card_no" id="re_pan_card_no">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group ">
                            ...
                            $pancardOption = [
                             ...
                             ?>
                            <?=_dropzoneCreateUpdate('pan_card_img','',$pancardOption)?>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" id="re_aadhar_card_no" name="re_aadhar_card_no">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group ">
                                    ...
                                    $aadharFrontOption = [
                                     ...
                                     ?>
                                    <?=_dropzoneCreateUpdate('aadhar_front_img','',$aadharFrontOption)?>
                            ...
                            <div class="col-6">
                                <div class="form-group ">
                                    ...
                                    $aadharBackOption = [
                                     ...
                                     ?>
                                    <?=_dropzoneCreateUpdate('aadhar_back_img','',$aadharBackOption)?>
                        ...
                        <div class="form-group ">
                            <label>Upload Signature</label>
                                    ...
                                    $signatureOption = [
                                     ...
                                     ?>
                                    <?=_dropzoneCreateUpdate('signature','',$signatureOption)?>
                        ...
                        <div class="form-group ">
                            <label>Upload Profile </label>
                                    ...
                                    $profileOption = [
                                     ...
                                     ?>
                                    <?=_dropzoneCreateUpdate('profile','',$profileOption)?>
            ...
            <div class="row mt-3 kyc_status" style="display: none">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="launch_username" placeholder="Sketch Name">
                          </div>
                          <div class="form-group ">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group mt-2">
                            <input type="text" name="twitter_link" id="youtube_link" class="form-control" placeholder="Twitter Link (optional)" >
                        </div>
                        <div class="form-group mt-2">
                            <input type="text" name="instra_link" id="youtube_link" class="form-control" placeholder="Instragram Link (optional)" >
                        </div>
                        <div class="form-group mt-2">
                            <input type="text" name="facebook_link" id="youtube_link" class="form-control" placeholder="Facebook Link (optional)" >
                        </div>
                        <div class="form-group mt-2">
                            <input type="text" name="linked_link" id="youtube_link" class="form-control" placeholder="Linkedin Link (optional)" >
                          </div>
