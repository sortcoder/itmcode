			...
			<form action="" method="post" id="createUser">
				...
				<div class="row">
					...
					<div class="col-6">
						...
						<input type="number" minlength="10" name="mobile" class="form-control" id="mobile" >
						<span class="text-danger errordisplay mobile"></span>
					</div>
					<div class="col-6">
						<label>Password</label>
						<input type="password" name="password" class="form-control" id="password">
						<span class="text-danger errordisplay password"></span>
					</div>

					<div class="col-6">
						<label>Confirm Password</label>
						<input type="password" name="cpassword" class="form-control" id="cpassword">
						<span class="text-danger errordisplay cpassword"></span>
					</div>
                    <div class="col-6">
                        <div class="form-group">
                            <strong>Role:</strong>
                            {!! Form::select('roles[]', $roles,[], array('class' => 'form-control multiple-select','multiple')) !!}
                        </div>
                    </div>
