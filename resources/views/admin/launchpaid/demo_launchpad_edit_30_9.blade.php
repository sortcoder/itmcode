...
<form action="" method="post" id="createUser">
    ...
    @method('PUT')
    <div class="card">
        <div class="card-header"><h5>Update Demo Launch Paid </h5></div>
        <div class="card-body">
            <div class="alertError" style="display: none;">
            </div>
            <div class="row">
                <div class="col-4 mt-2">
                    <label for="username">Launch Paid Type</label>
                    <?=\Config::get('constants.launcherTypes')[$user->launc_paid_type]?>
                </div>
                <div class="col-4 mt-2">
                    <label for="price">Is Recommended</label>
