...
<form action="" method="post" id="createUser">
    <div class="card">
        <div class="card-header"><h6>Create Demo Launch Paid</h6></div>
                    ...
                    <div class="col-8">
                        ...
                        <div class="form-group ">
                          <label for="username">User Name</label> 
                            ...
                            <select name="demo_user_name" id="demo_user_name" class="form-control">
                                <option value="">Select User</option>
                                @foreach($get_user as $user_val)
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control" required name="launch_sketch" placeholder="Sketch Name">
                        </div>
                            ...
                            <label for="username">Designation</label>
                             <select name="launch_designation" id="launch_designation" class="form-control">
                                ...
                                @foreach($get_designation as $getDes_val)
                                    <option value="{{ $getDes_val->name }}">{{ $getDes_val->name }}</option>
                                @endforeach
                            </select>
                          </div>
                          <div class="form-group ">
                          ...
                          <div class="form-group ">
                            ...
                            <input type="number" required placeholder="Image Quantity" class="form-control image_quantity" name="image_quantity" id="image_quantity">
                          </div>
                          <div class="form-group ">
                            <label for="username">Selling Price </label>
                            <input type="number" required placeholder="Selling Price" class="form-control image_selling_price" name="image_selling_price" id="image_selling_price">
                          </div>
                          <div class="form-group ">
